...
In order to store the final database with the selected bills and comments, an MySQL\footnote{\url{https://www.mysql.com}} Database was created, whose Entity-Relation Model\footnote{\url{https://en.wikipedia.org/wiki/Entity\%E2\%80\%93relationship_model}} can be presented in the following layout.
\newpage
\begin{figure}[H]
\centering
